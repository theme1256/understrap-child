...
$colorScheme = new UnderStrapChild_Color_Scheme();
add_action('wp_head', 'child_understrap_styles_colors', 100);
function child_understrap_styles_colors()
{
    global $colorScheme;
    echo "<style>". $colorScheme->get_css($colorScheme->get_color_scheme())."</style>";
}